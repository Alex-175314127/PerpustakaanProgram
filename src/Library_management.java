...
public class Library_management extends JFrame implements ActionListener{
    ...
    private JButton addButton, veiwButton, editButton, deleteButton, clearButton, exitButton;
    ...
    public Library_management(){
        ...
        veiwButton.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == addButton){
            ...
            books.add(book);
            JOptionPane.showMessageDialog(this, "Book added Success");
            clearFields();
        } else if (e.getSource() == veiwButton) {
            String[] colums = {"Book ID", "Book Title","Author", "Publisher", "Year of Publication", "ISBN", "Number of Copies"};
            ...
            for (int i = 0; i < books.size(); i++) {
                if(books.get(i)[0].equals(bookID)){
                    ...
                    book[6] = textField7.getText();
                    books.set(i, book);
                    JOptionPane.showMessageDialog(this, "Book edited success");
                    clearFields();
                    return;
                }
            }
